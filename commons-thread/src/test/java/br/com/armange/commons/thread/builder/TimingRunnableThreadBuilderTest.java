...
public class TimingRunnableThreadBuilderTest {
    ...
    public void noSchedule() {
        ...
        final ExecutorResult<?> result = TimingRunnableThreadBuilder.newBuilder(1).setExecution(localRunnable).start();
    ...
    public void noScheduleCaughtException() {
        ...
        final ExecutorResult<?> result = TimingRunnableThreadBuilder.newBuilder(1)
                .setExecution(localRunnableWithException).setSilentInterruption(true)
    ...
    public void useDelayCaughtException() {
        ...
        final ThrowableConsumer throwableConsumer = spy(new ThrowableConsumer());
        final ExecutorResult<?> result = TimingRunnableThreadBuilder.newBuilder(1)
                .setExecution(localRunnableWithException).setDelay(2000).setSilentInterruption(true)
                .setUncaughtExceptionConsumer(throwableConsumer).start();
    ...
    public void cancelByTimeout() {
        final LocalRunnable localRunnable = spy(new LocalRunnable());
        final ExecutorResult<?> result = TimingRunnableThreadBuilder.newBuilder(1).setExecution(() -> {
            sleepUnchecked(2000);
            localRunnable.run();
    ...
    public void runBeforeTimeout() {
        final LocalRunnable localRunnable = spy(new LocalRunnable());
        final ExecutorResult<?> result = TimingRunnableThreadBuilder.newBuilder(1).setExecution(localRunnable)
                .setTimeout(3000).setMayInterruptIfRunning(true).setSilentInterruption(true).start();
    ...
    public void runBeforeTimeoutCaughtException() {
        ...
        final ThrowableConsumer throwableConsumer = spy(new ThrowableConsumer());
        final ExecutorResult<?> result = TimingRunnableThreadBuilder.newBuilder(1)
                .setExecution(localRunnableWithException).setTimeout(3000).setMayInterruptIfRunning(true)
    ...
    public void useIntervalAndDelay() {
        final LocalRunnable localRunnable = spy(new LocalRunnable());
        final ExecutorResult<?> result = TimingRunnableThreadBuilder.newBuilder(1).setExecution(localRunnable)
                .setDelay(1000).setInterval(1000).setSilentInterruption(true).start();
    ...
    public void useIntervalAndDelayAndCaughtException() {
        ...
        final ThrowableConsumer throwableConsumer = spy(new ThrowableConsumer());
        final ExecutorResult<?> result = TimingRunnableThreadBuilder.newBuilder(1)
                .setExecution(localRunnableWithException).setDelay(1000).setInterval(1000)
                .setUncaughtExceptionConsumer(throwableConsumer).setSilentInterruption(true).start();
    ...
    public void useTimeoutAndInterval() {
        final LocalRunnable localRunnable = spy(new LocalRunnable());
        final ExecutorResult<?> result = TimingRunnableThreadBuilder.newBuilder(1).setExecution(localRunnable)
                .setTimeout(3000).setInterval(1000).setMayInterruptIfRunning(true).setSilentInterruption(true).start();
    ...
    public void useTimeoutAndIntervalCaughtException() {
        ...
        final ThrowableConsumer throwableConsumer = spy(new ThrowableConsumer());
        final ExecutorResult<?> result = TimingRunnableThreadBuilder.newBuilder(1)
                .setExecution(localRunnableWithException).setTimeout(3000).setInterval(1000)
    ...
    public void useAllDelayAndTimeout() {
        ...
        final ExecutorResult<?> result = TimingRunnableThreadBuilder.newBuilder(1).setExecution(localRunnable)
                .setDelay(1000).setTimeout(2000).setMayInterruptIfRunning(true).start();
